// https://gist.githubusercontent.com/wKich/25b4a7b23a1f990f8c7d09fec7585b53/raw/5117049edf2ca0958d4dcb681aabf5ba28bc3639/toPx.js
...
export function toPx(elem, value, prop = "width", force) {
  if (!preCalculated) {
    preCalculated = true;
    preCalculate();
  }
...
function preCalculate() {
  ...
  ["mozmm2px", "in2px", "pc2px", "pt2px", "cm2px", "mm2px"].forEach(
    (conversion) =>
...
function curCSS(elem, prop) {
  const pixel =
    elem.style[`pixel${prop.charAt(0).toUpperCase()}${prop.slice(1)}`];
  let value;
